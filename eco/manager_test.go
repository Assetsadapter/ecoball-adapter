...
func testNewWalletManager() *WalletManager {
	...
	//读取配置
	absFile := filepath.Join("conf", "BSC.ini")
...
func TestWalletManager_GetAddrBalance(t *testing.T) {
	...
	balance, err := wm.GetAddrBalance("0x72b61c6014342d914470eC7aC2975bE345796c2b", "pending")
	if err != nil {
...
func TestWalletManager_GetTransactionCount(t *testing.T) {
	wm := testNewWalletManager()
	count, err := wm.GetTransactionCount("0x5d5f7cede7ddc072ab2ae55a591d7d0eaec92210")
	if err != nil {
